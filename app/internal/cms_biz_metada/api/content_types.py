...
async def create_content_type_api(
    ...
    await write_log(
        ...
        operation_object_code="OBJ_CONTENT_TYPE", operation_object_params={"name": body.name},
        operation_content_code="LOG_CONTENT_TYPE_CREATE", operation_content_params={"name": body.name},
...
async def update_content_type_api(
    ...
    await write_log(
        ...
        operation_object_code="OBJ_CONTENT_TYPE", operation_object_params={"name": old_name},
        operation_content_code="LOG_CONTENT_TYPE_EDIT", operation_content_params={"name": ct.name},
        ip_address=_get_ip(request),
        result="success",
        previous_value=prev_val,
        updated_value=new_val,
...
async def batch_delete_content_types_api(
    ...
    await write_log(
        ...
        operation_object_code="OBJ_CONTENT_TYPE", operation_object_params={"name": ct_names},
        operation_content_code="LOG_CONTENT_TYPE_BATCH_DELETE", operation_content_params={"names": ct_names},
        ip_address=_get_ip(request),
        result="success",
        entity_type="content_type",
...
async def delete_content_type_api(
    ...
    await write_log(
        ...
        operation_object_code="OBJ_CONTENT_TYPE", operation_object_params={"name": ct_name},
        operation_content_code="LOG_CONTENT_TYPE_DELETE", operation_content_params={"name": ct_name},
        ip_address=_get_ip(request),
        result="success",
        previous_value=prev_val,
        updated_value=new_val,
