...
async def create_genre_api(
    ...
    await write_log(
        ...
        operation_object=f"题材 {body.name}",
        operation_content=f"Created genre: name={body.name}, language={body.language}",
...
async def update_genre_api(
    ...
    await write_log(
        ...
        operation_object=f"题材 {old_name}",
        operation_content=f"Updated genre: ID={genre_id}, name={genre.name}",
        ip_address=_get_ip(request),
        result="success",
        previous_value=prev_val,
        updated_value=new_val,
...
async def batch_delete_genres_api(
    ...
    await write_log(
        ...
        operation_object=f"题材 {genre_names}",
        operation_content=f"批量删除题材: {genre_names}",
        ip_address=_get_ip(request),
        result="success",
        entity_type="genre",
...
async def delete_genre_api(
    ...
    await write_log(
        ...
        operation_object=f"题材 {genre_name}",
        operation_content=f"Deleted genre: ID={genre_id}, name={genre_name}",
        ip_address=_get_ip(request),
        result="success",
        previous_value=prev_val,
        updated_value=new_val,
