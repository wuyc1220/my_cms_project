...
async def create_cast_api(
    ...
    await write_log(
        ...
        operation_object_code="OBJ_CAST", operation_object_params={"name": body.name},
        operation_content_code="LOG_CAST_CREATE", operation_content_params={"name": body.name},
...
async def batch_delete_casts_api(
    ...
    await write_log(
        ...
        operation_object_code="OBJ_CAST", operation_object_params={"name": cast_names},
        operation_content_code="LOG_CAST_BATCH_DELETE", operation_content_params={"names": cast_names},
        ip_address=_get_ip(request),
        result="success",
        entity_type="cast",
...
async def update_cast_api(
    ...
    await write_log(
        ...
        operation_object_code="OBJ_CAST", operation_object_params={"name": old.name},
        operation_content_code="LOG_CAST_EDIT", operation_content_params={"name": cast.name},
        ip_address=_get_ip(request),
        result="success",
        previous_value=prev_val,
        updated_value=new_val,
...
async def delete_cast_api(
    ...
    await write_log(
        ...
        operation_object_code="OBJ_CAST", operation_object_params={"name": cast_name},
        operation_content_code="LOG_CAST_DELETE", operation_content_params={"name": cast_name},
        ip_address=_get_ip(request),
        result="success",
        previous_value=prev_val,
        updated_value=new_val,
