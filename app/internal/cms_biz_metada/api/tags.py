...
async def create_tag_api(
    ...
    await write_log(
        ...
        operation_object_code="OBJ_TAG", operation_object_params={"name": body.name},
        operation_content_code="LOG_TAG_CREATE", operation_content_params={"name": body.name},
...
async def update_tag_api(
    ...
    await write_log(
        ...
        operation_object_code="OBJ_TAG", operation_object_params={"name": old_name},
        operation_content_code="LOG_TAG_EDIT", operation_content_params={"name": tag.name},
        ip_address=_get_ip(request),
        result="success",
        previous_value=prev_val,
        updated_value=new_val,
...
async def batch_delete_tags_api(
    ...
    await write_log(
        ...
        operation_object_code="OBJ_TAG", operation_object_params={"name": tag_names},
        operation_content_code="LOG_TAG_BATCH_DELETE", operation_content_params={"names": tag_names},
        ip_address=_get_ip(request),
        result="success",
        entity_type="tag",
...
async def delete_tag_api(
    ...
    await write_log(
        ...
        operation_object_code="OBJ_TAG", operation_object_params={"name": tag_name},
        operation_content_code="LOG_TAG_DELETE", operation_content_params={"name": tag_name},
        ip_address=_get_ip(request),
        result="success",
        previous_value=prev_val,
        updated_value=new_val,
